...
class Selector extends String {
    ...
    create(str) {
        return new this.constructor(this.execFirst(str));
    }
}

class ExecutedSelector extends Selector {
    constructor(str) {
        super(str);
...
class NextAdjacentSelector extends Selector {
    get regex() {
        return /^\s*\+\s*/;
    }
} 

class NextSiblingsSelector extends Selector {
    get regex() {
        return /^\s*\~\s*/;
    }
} 
...
class TagSelector extends ExecutedSelector {
    get regex() {
        return /^([A-Za-z][A-Za-z0-9]*)/;
    }
}

class IdSelector extends ExecutedSelector {
    get regex() {
        return /^#([A-Za-z][A-Za-z0-9]*)/;
    }
}

class ClassSelector extends ExecutedSelector {
    get regex() {
        return /^\.([A-Za-z][A-Za-z0-9]*)/;
    }
}

class PseudoSelector extends ExecutedSelector {
    get regex() {
...
class PseudoFunction1ArgQuotedSelector extends ExecutedSelector {
    get regex() {
        return /^\:([A-Za-z][-A-Za-z0-9]*[A-Za-z0-9]+)\(\"([^"]*)\"\)/;
    }
}

class PseudoFunction1ArgSelector extends ExecutedSelector {
    get regex() {
        return /^\:([A-Za-z][-A-Za-z0-9]*[A-Za-z0-9]+)\(([^)]+)\)/;
    }
}

class AttributeSelector extends ExecutedSelector {
    get regex() {
        return /^\[([A-Za-z][A-Za-z0-9]*)]/;
    }
}

class AttributeEqualsSelector extends ExecutedSelector {
    get regex() {
        return /^\[([A-Za-z][A-Za-z0-9]*)=\"([^"]*)\"\]/;
    }
}

class AttributeNotEqualsSelector extends ExecutedSelector {
    get regex() {
        return /^\[([A-Za-z][A-Za-z0-9]*)\!=\"([^"]*)\"\]/;
    }
}

class AttributePrefixSelector extends ExecutedSelector {
    get regex() {
        return /^\[([A-Za-z][A-Za-z0-9]*)\|=\"([^"]*)\"\]/;
    }
}

class AttributeContainsSelector extends ExecutedSelector {
    get regex() {
        return /^\[([A-Za-z][A-Za-z0-9]*)\*=\"([^"]*)\"\]/;
    }
}
...
class AttributeContainsWordSelector extends ExecutedSelector {
    get regex() {
        return /^\[([A-Za-z][A-Za-z0-9]*)\~=\"([^"]*)\"\]/;
    }
}

class AttributeEndsWithSelector extends ExecutedSelector {
    get regex() {
        return /^\[([A-Za-z][A-Za-z0-9]*)\$=\"([^"]*)\"\]/;
    }
}

class AttributeStartsWithSelector extends ExecutedSelector {
    get regex() {
        return /^\[([A-Za-z][A-Za-z0-9]*)\^=\"([^"]*)\"\]/;
    }
}
